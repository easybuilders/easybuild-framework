...
A member of the EasyBuild team will then review your pull request, paying attention to what you're contributing, how you implemented it and [https://github.com/hpcugent/easybuild/wiki/Code-style](Code style).
