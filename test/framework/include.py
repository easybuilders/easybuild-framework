...
class IncludeTest(EnhancedTestCase):
    ...
    def test_include_easyblocks(self):
        ...
        write_file(
            os.path.join(myeasyblocks, "__init__.py"),
            "# dummy init, should not get included",
        )
        write_file(
            os.path.join(myeasyblocks, "generic", "__init__.py"),
            "# dummy init, should not get included",
        )
        ...
        write_file(
            os.path.join(myeasyblocks, "generic", "mybar.py"), mybar_easyblock_txt
        )
        ...
        expected_paths = [
            "__init__.py",
            "easyblocks/__init__.py",
            "easyblocks/myfoo.py",
            "easyblocks/generic/__init__.py",
            "easyblocks/generic/mybar.py",
        ]
    ...
    def test_include_easyblocks_priority(self):
        ...
        foo_real_py_path = os.path.realpath(
            os.path.join(os.path.dirname(foo_pyc_path), "foo.py")
        )
        self.assertFalse(
            os.path.samefile(os.path.dirname(foo_pyc_path), test_easyblocks)
        )
        self.assertTrue(
            os.path.samefile(foo_real_py_path, os.path.join(myeasyblocks, "foo.py"))
        )
    ...
    def test_include_mns(self):
        ...
        # include __init__.py file that should be ignored, and shouldn't cause trouble (bug #1697)
        write_file(
            os.path.join(my_mns, "__init__.py"), "# dummy init, should not get included"
        )
        ...
        # include custom MNS
        included_mns_path = include_module_naming_schemes(
            self.test_prefix, [os.path.join(my_mns, "*.py"), my_mns_bis]
        )

        expected_paths = [
            "__init__.py",
            "tools/__init__.py",
            "tools/module_naming_scheme/__init__.py",
        ...
        my_mns_real_py_path = os.path.realpath(
            os.path.join(os.path.dirname(my_mns_pyc_path), "my_mns.py")
        )
    ...
    def test_include_toolchains(self):
        ...
        # include __init__.py file that should be ignored, and shouldn't cause trouble (bug #1697)
        write_file(
            os.path.join(my_toolchains, "__init__.py"),
            "# dummy init, should not get included",
        )
        ...
        write_file(
            os.path.join(my_toolchains, "compiler", "my_compiler.py"), my_compiler_txt
        )
        ...
        expected_paths = [
            ...
            "toolchains/compiler/__init__.py",
            "toolchains/my_tc.py",
    ...
    def test_is_software_specific_easyblock(self):
        ...
        self.assertErrorRegex(
            EasyBuildError,
            "No such file",
            is_software_specific_easyblock,
            "/no/such/easyblock.py",
        )
        ...
        self.assertTrue(
            is_software_specific_easyblock(os.path.join(test_easyblocks, "g", "gcc.py"))
        )
        self.assertTrue(
            is_software_specific_easyblock(os.path.join(test_easyblocks, "t", "toy.py"))
        )

        self.assertFalse(
            is_software_specific_easyblock(
                os.path.join(test_easyblocks, "generic", "configuremake.py")
            )
        )
        self.assertFalse(
            is_software_specific_easyblock(
                os.path.join(test_easyblocks, "generic", "toolchain.py")
            )
        )
