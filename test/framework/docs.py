...
class DocsTest(EnhancedTestCase):
    ...
    def test_list_toolchains(self):
        ...
        for txt in (list_toolchains(), list_toolchains(output_format='txt')):
            self.assertMultiRegex(txt_patterns, txt)
        ...
        self.assertMultiRegex(md_patterns, txt_md)
        ...
        self.assertMultiRegex(rst_patterns, txt_rst)
    ...
    def test_avail_toolchain_opts(self):
        ...
        for txt in (avail_toolchain_opts('foss'), avail_toolchain_opts('foss', output_format='txt')):
            self.assertMultiRegex(txt_patterns_foss, txt)
        ...
        for txt in (avail_toolchain_opts('intel'), avail_toolchain_opts('intel', output_format='txt')):
            self.assertMultiRegex(txt_patterns_intel, txt)
        ...
        self.assertMultiRegex(md_patterns_foss, txt_md)
        ...
        self.assertMultiRegex(md_patterns_intel, txt_md)
        ...
        self.assertMultiRegex(rst_patterns_foss, txt_rst)
        ...
        self.assertMultiRegex(rst_patterns_intel, txt_rst)
    ...
    def test_help(self):
        ...
        self.assertMultiRegex(short_patterns, txt_short)
        ...
        self.assertMultiRegex(config_patterns, txt_cfg)
