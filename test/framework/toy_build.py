...
class ToyBuildTest(EnhancedTestCase):
    ...
    def test_toy_tweaked(self):
        ...
        if get_module_syntax() == 'Tcl':
            ...
            self.assertTrue(re.search(r'^prepend-path\s*SOMEPATH\s*:$', toy_module_txt, re.M))
            ...
            self.assertTrue(re.search(r'^prepend-path\s*SOMEPATH_APPEND\s*:$', toy_module_txt, re.M))
            ...
            self.assertTrue(re.search(r'^prepend_path\("SOMEPATH", ":"\)$', toy_module_txt, re.M))
            ...
            self.assertTrue(re.search(r'^prepend_path\("SOMEPATH_APPEND", ":"\)$', toy_module_txt, re.M))
