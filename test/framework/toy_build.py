...
class ToyBuildTest(EnhancedTestCase):
    ...
    def test_toy_cuda_sanity_check(self):
        ...
        additional_code_error = "Files with additional CUDA device code: 4."
        missing_code_error = "Files missing CUDA device code: 4"
        missing_ptx_error = "Files missing CUDA PTX code: 4"
        test_cases = (
            ('',
