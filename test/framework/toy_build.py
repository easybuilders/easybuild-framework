...
class ToyBuildTest(EnhancedTestCase):
    ...
    def run_toy_build(self, extra_args=None, ec_file=None, tmpdir=None, verify=True, fails=False, verbose=True,
    ...
    def run_test_toy_build_with_output(self, *args, **kwargs):
        """Run run_toy_build with specified arguments, catch stdout/stderr and return it."""

        self.mock_stderr(True)
        self.mock_stdout(True)
        self.run_toy_build(*args, **kwargs)
    ...
    def test_toy_broken(self):
        ...
        self.assertErrorRegex(EasyBuildError, error_regex, self.run_toy_build, ec_file=broken_toy_ec, tmpdir=tmpdir,
        ...
        self.run_toy_build(ec_file=broken_toy_ec, tmpdir=tmpdir, verify=False, fails=True, verbose=False,
    ...
    def test_toy_buggy_easyblock(self):
        ...
        self.assertErrorRegex(EasyBuildError, err_regex, self.run_toy_build, **kwargs)
    ...
    def test_toy_permissions_installdir(self):
        ...
        self.run_toy_build(ec_file=test_ec)
        ...
        for extra_args in test_cases:
            self.mock_stdout(True)
            self.run_toy_build(ec_file=test_ec, extra_args=['--read-only-installdir'] + extra_args, force=False)
            self.mock_stdout(False)
        ...
        self.run_toy_build(ec_file=test_ec, extra_args=['--group-writable-installdir'])
        installdir_perms = os.stat(toy_install_dir).st_mode & 0o777
        ...
        test_ec_txt += "\nmake_module = False"
        write_file(test_ec, test_ec_txt)
        self.run_toy_build(ec_file=test_ec, extra_args=['--read-only-installdir'], verify=False, raise_error=True)
    ...
    def test_toy_gid_sticky_bits(self):
        ...
        self.run_toy_build(extra_args=['--set-gid-bit', '--sticky-bit'])
    ...
    def test_allow_system_deps(self):
        ...
        self.run_toy_build(ec_file=ec_file)
        shutil.rmtree(tmpdir)
    ...
    def test_toy_advanced(self):
        ...
        self.run_toy_build(ec_file=test_ec, versionsuffix='-gompi-2018a-test', extra_args=['--debug'])
    ...
    def test_toy_advanced_filter_deps(self):
        ...
        self.run_toy_build(ec_file=test_ec, versionsuffix='-gompi-2018a-test', extra_args=["--filter-deps=FFTW"])
    ...
    def test_toy_hidden_cmdline(self):
        ...
        self.run_toy_build(ec_file=ec_file, extra_args=['--hidden'], verify=False)
    ...
    def test_toy_hidden_easyconfig(self):
        ...
        write_file(ec_file, "\nhidden = True\n", append=True)
        self.run_toy_build(ec_file=ec_file, verify=False)
        # module file is hidden
        toy_module = os.path.join(self.test_installpath, 'modules', 'all', 'toy', '.0.0')
        if get_module_syntax() == 'Lua':
            toy_module += '.lua'
    ...
    def test_toy_archived_easyconfig(self):
        ...
        self.run_toy_build(raise_error=True, extra_args=extra_args)
    ...
    def test_toy_extension_sources(self):
        ...
        for bar_sources_spec in bar_sources_specs:
            ...
            write_file(test_ec, test_ec_txt)
            self.run_toy_build(ec_file=test_ec, raise_error=True)
            ...
            self.assertErrorRegex(EasyBuildError, error_pattern, self.run_toy_build, ec_file=test_ec,
    ...
    def test_external_dependencies(self):
        ...
        self.run_toy_build(ec_file=toy_ec, versionsuffix='-external-deps', verbose=True, raise_error=True)
        ...
        self.assertErrorRegex(EasyBuildError, err_msg, self.run_toy_build, ec_file=toy_ec,
                              raise_error=True, verbose=False)
        ...
        outtxt = self.run_toy_build(ec_file=toy_ec, verbose=True, extra_args=['--dry-run'], verify=False)
    ...
    def test_package(self):
        ...
        self.run_toy_build(extra_args=extra_args)
    ...
    def test_package_skip(self):
        ...
        self.run_toy_build(['--packagepath=%s' % pkgpath])
        self.assertNotExists(pkgpath, "%s is not created without use of --package" % pkgpath)

        self.mock_stdout(True)
        self.run_toy_build(extra_args=['--package', '--skip'], verify=False)
        self.mock_stdout(False)
    ...
    def test_regtest(self):
        ...
        self.run_toy_build(extra_args=['--regtest', '--sequential'], verify=False)
    ...
    def test_minimal_toolchains(self):
        ...
        self.run_toy_build(extra_args=['--minimal-toolchains'])
    ...
    def test_reproducibility(self):
        ...
        self.mock_stdout(True)
        self.run_toy_build(extra_args=['--minimal-toolchains', '--easyblock=EB_toytoy', '--hooks=%s' % hooks_file])
        self.mock_stdout(False)
    ...
    def test_reproducibility_ext_easyblocks(self):
        ...
        self.run_toy_build(ec_file=ec1, verify=False, extra_args=['--minimal-toolchains', '--easyblock=EB_toytoy'])
    ...
    def test_toy_toy(self):
        ...
        self.run_toy_build(ec_file=self.test_prefix, verify=False)
    ...
    def test_sanity_check_paths_lib64(self):
        ...
        self.run_toy_build(ec_file=test_ec, extra_args=['--disable-lib64-lib-symlink'], raise_error=True)
    ...
    def test_toy_build_enhanced_sanity_check(self):
        ...
        self.mock_stdout(True)
        self.run_toy_build(ec_file=test_ec, extra_args=eb_args, verify=False, testing=False, raise_error=True)
        stdout = self.get_stdout()
        self.mock_stdout(False)
    ...
    def test_toy_filter_env_vars(self):
        ...
        self.run_toy_build(extra_args=['--filter-env-vars=LD_LIBRARY_PATH,PATH'])
        toy_mod_txt = read_file(toy_mod_path)
    ...
    def test_toy_iter(self):
        ...
        for extra_args in [None, ['--minimal-toolchains']]:
            ...
            self.run_toy_build(ec_file=toy_ec, extra_args=extra_args, versionsuffix='-iter')
    ...
    def test_toy_rpath(self):
        ...
        args = ['--rpath']
        self.run_toy_build(extra_args=args, raise_error=True)
        ...
        self.assertErrorRegex(EasyBuildError, error_pattern, self.run_toy_build, extra_args=eb_args, raise_error=True,
                              verbose=False)
        ...
        self.run_toy_build(ec_file=toy_ec, extra_args=['--rpath'], raise_error=True)
    ...
    def test_toy_filter_rpath_sanity_libs(self):
        ...
        args = ['--rpath']
        self.run_toy_build(ec_file=toy_ec, name='toy-app', extra_args=args, raise_error=True)
        ...
        self.assertErrorRegex(EasyBuildError, error_pattern, self.run_toy_build, ec_file=toy_ec,
    ...
    def test_toy_modaltsoftname(self):
        ...
        self.run_toy_build(ec_file=self.test_prefix, verify=False, extra_args=extra_args, raise_error=True)
    ...
    def test_toy_build_trace(self):
        ...
        self.mock_stderr(True)
        self.mock_stdout(True)
        self.run_toy_build(ec_file=test_ec, extra_args=['--trace'], verify=False, testing=False)
        stderr = self.get_stderr()
        stdout = self.get_stdout()
        self.mock_stderr(False)
        self.mock_stdout(False)
    ...
    def test_toy_build_hooks(self):
        ...
        self.mock_stderr(True)
        self.mock_stdout(True)
        self.run_toy_build(ec_file=test_ec, extra_args=['--hooks=%s' % hooks_file], raise_error=True, debug=False)
        stderr = self.get_stderr()
        stdout = self.get_stdout()
        self.mock_stderr(False)
        self.mock_stdout(False)
    ...
    def test_toy_multi_deps(self):
        ...
        if self.modtool.supports_depends_on:
            ...
            remove_file(toy_mod_file)
            self.run_toy_build(ec_file=test_ec, extra_args=['--module-depends-on'], raise_error=True)
    ...
    def test_fix_shebang(self):
        ...
        self.run_toy_build(ec_file=test_ec, extra_args=extra_args, raise_error=True)
    ...
    def test_toy_build_lock(self):
        ...
        self.assertErrorRegex(EasyBuildError, error_pattern, self.run_toy_build, raise_error=True, verbose=False)
        ...
        self.run_toy_build(extra_args=extra_args, verify=True, raise_error=True)

        # put lock in place in custom locks dir, try again
        toy_lock_path = os.path.join(locks_dir, toy_lock_fn)
        mkdir(toy_lock_path, parents=True)
        self.assertErrorRegex(EasyBuildError, error_pattern, self.run_toy_build,
                              extra_args=extra_args, raise_error=True, verbose=False)

        # also test use of --ignore-locks
        self.run_toy_build(extra_args=extra_args + ['--ignore-locks'], verify=True, raise_error=True)
        ...
        for opts in test_cases:
            ...
            with RemoveLockAfter(3, toy_lock_path):
                self.mock_stderr(True)
                self.mock_stdout(True)
                self.run_toy_build(extra_args=all_args, verify=False, raise_error=True, testing=False)
        ...
        self.assertErrorRegex(EasyBuildError, error_pattern, self.run_toy_build, extra_args=all_args,
    ...
    def test_toy_lock_cleanup_signals(self):
        ...
        for (signum, exc) in signums:
            ...
            with WaitAndSignal(1, signum):
                ...
                self.mock_stderr(True)
                self.mock_stdout(True)
                self.assertErrorRegex(exc, '.*', self.run_toy_build, ec_file=test_ec, verify=False,
    ...
    def test_toy_build_lib64_lib_symlink(self):
        ...
        self.run_toy_build(extra_args=['--disable-lib64-lib-symlink'])
    ...
    def test_toy_build_lib_lib64_symlink(self):
        ...
        remove_dir(self.test_installpath)
        self.run_toy_build(ec_file=test_ec, extra_args=['--disable-lib-lib64-symlink'])
    ...
    def test_toy_build_sanity_check_linked_libs(self):
        ...
        self.run_toy_build(ec_file=libtoy_ec, raise_error=True, verbose=False, verify=False)
        ...
        self.assertErrorRegex(EasyBuildError, error_msg, self.run_toy_build, force=False,
        ...
        self.run_toy_build(ec_file=libtoy_ec, extra_args=['--module-only'], force=False,
        ...
        write_file(test_ec, test_ec_txt)
        self.run_toy_build(ec_file=test_ec, extra_args=['--module-only'], force=False,
                           raise_error=True, verbose=False, verify=False)
        ...
        self.run_toy_build(ec_file=test_ec, extra_args=args, force=False,
                           raise_error=True, verbose=False, verify=False)
    ...
    def test_toy_unavailable_os_dep(self):
        ...
        self.mock_stderr(True)
        self.mock_stdout(True)
        self.run_toy_build(ec_file=test_ec, force=False, raise_error=False, verify=False,
    ...
    def test_toy_post_install_messages(self):
        ...
        self.mock_stderr(True)
        self.mock_stdout(True)
        self.run_toy_build(ec_file=test_ec, test_report=test_report_fp)
        stdout = self.get_stdout()
        self.mock_stderr(False)
        self.mock_stdout(False)
    ...
    def test_toy_build_info_msg(self):
        ...
        with self.mocked_stdout_stderr():
            self.run_toy_build(ec_file=test_ec, testing=False, verify=False, raise_error=True)
            stdout = self.get_stdout()
