...
# test subsuites to fix: hooks, repository (?)
for subsuite in asyncprocess build_log config containers docs easyblock easyconfig easyconfigformat easyconfigparser easyconfigversion ebconfigobj environment filetools format_convert github include license module_generator modules modulestool options package parallelbuild robot run scripts systemtools toolchain toolchainvariables toy_build tweak type_checking variables yeb; do
