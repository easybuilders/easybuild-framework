...
##
"""
CrayIntel toolchain: Intel compilers and MPI via Cray compiler drivers + MKL (PrgEnv-intel) and Cray FFTW
...
from easybuild.toolchains.linalg.craymkl import CrayMKL
