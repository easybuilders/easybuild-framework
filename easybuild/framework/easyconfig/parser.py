...
DEPRECATED_PARAMETERS = {
    ...
    # 'moduleclass': ('env_mod_class', '6.0'),  # TODO
    # 'module_depends_on': ('env_mod_depends_on', '6.0'),   # TODO
    ...
    # 'recursive_module_unload': ('recursive_env_mod_unload', '6.0'),   # TODO
    ...
    # 'versionprefix': ('version_prefix', '6.0'),   # TODO
    # 'versionsuffix': ('version_suffix', '6.0'),   # TODO
}
