...
if os_name in arch_distros:
    EASYCONFIG_CONSTANTS['OS_PKG_IBVERBS_DEV'] = (('rdma-core'), "OS packages providing ibverbs/infiniband development support")
    EASYCONFIG_CONSTANTS['OS_PKG_OPENSSL_LIB'] = (('openssl'),"OS packages providing openSSL libraries")
    EASYCONFIG_CONSTANTS['OS_PKG_PAM_DEV'] = (('pam'),"OS packages providing Pluggable Authentication Module (PAM) developement support")