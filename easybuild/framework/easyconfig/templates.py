...
TEMPLATE_CONSTANTS = [
    ...
    ('BITBUCKET_SOURCE', 'http://bitbucket.org/%(bitbucket_account)s/%(namelower)s/get',
     'bitbucket.org source url (requires bitbucket_account easyconfig parameter to be specified)'),
    ('BITBUCKET_DOWNLOADS', 'http://bitbucket.org/%(bitbucket_account)s/%(namelower)s/downloads',
     'bitbucket.org downloads url (requires bitbucket_account easyconfig parameter to be specified)'),
