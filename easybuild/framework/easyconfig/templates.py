...
TEMPLATE_CONSTANTS = [
    ...
    ('SOURCELOWER_TAR_GZ', '%(namelower)s-%(version)s.tar.gz', "Source .tar.gz tarball with lowercase name"),
    ('SOURCELOWER_TAR_XZ', '%(namelower)s-%(version)s.tar.xz', "Source .tar.xz tarball with lowercase name"),
    ('SOURCELOWER_TAR_BZ2', '%(namelower)s-%(version)s.tar.bz2', "Source .tar.bz2 tarball with lowercase name"),

    ('SOURCE_TGZ', '%(name)s-%(version)s.tgz', "Source .tgz tarball"),
    ('SOURCE_TXZ', '%(name)s-%(version)s.txz', "Source .txz tarball"),
    ('SOURCE_TBZ2', '%(name)s-%(version)s.tbz2', "Source .tbz2 tarball"),
    ('SOURCE_TB2', '%(name)s-%(version)s.tb2', "Source .tb2 tarball"),
    ('SOURCELOWER_TGZ', '%(namelower)s-%(version)s.tgz', "Source .tgz tarball with lowercase name"),
    ('SOURCELOWER_TXZ', '%(namelower)s-%(version)s.txz', "Source .txz tarball with lowercase name"),
    ('SOURCELOWER_TBZ2', '%(namelower)s-%(version)s.tbz2', "Source .tbz2 tarball with lowercase name"),
    ('SOURCELOWER_TB2', '%(namelower)s-%(version)s.tb2', "Source .tb2 tarball with lowercase name"),
