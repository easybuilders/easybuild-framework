...
GROUPED_PARAMS = [
    ...
    ['osdependencies'],
    ['pre_configure_cmds', 'preconfigopts', 'configure_cmd', 'configopts'],
    ['pre_build_cmds', 'prebuildopts', 'build_cmd', 'buildopts'],
    ['pre_test_cmds', 'pretestopts', 'test_cmd', 'testopts'],
    ['pre_install_cmds', 'preinstallopts', 'install_cmd', 'installopts'],
