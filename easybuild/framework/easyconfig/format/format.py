...
GROUPED_PARAMS = [
    ...
    ['osdependencies'],
    ['preconfigcmds', 'preconfigopts', 'configure_cmd', 'configopts'],
    ['prebuildcmds', 'prebuildopts', 'build_cmd', 'buildopts'],
    ['pretestcmds', 'pretestopts', 'test_cmd', 'testopts'],
    ['preinstallcmds', 'preinstallopts', 'install_cmd', 'installopts'],
