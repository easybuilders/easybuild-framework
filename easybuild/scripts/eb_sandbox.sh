...
help() {
    ...
    echo "  -b: Specify easyblocks user:branch or PR (default: ${DEFAULT_EASYBLOCKS_BRANCH})"
    echo "  -c: Specify easyconfigs PR (passed to --from-pr)"
    echo "  -d: Enable debugging"
    echo "  -f: Specify framework user:branch or PR (default: ${DEFAULT_FRAMEWORK_BRANCH})"
