...
build_path = os.path.join(prefix, bdir)
install_path = os.path.join(prefix, idir)
source_path = os.path.join(prefix, sdir)
...
# general cleanliness
del os, get_log, config, log, prefix, bdir, idir, sdir
