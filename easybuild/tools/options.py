    ...
    def override_options(self):
        ...
        opts = OrderedDict({
            ...
            'allow-modules-tool-mismatch': ("Allow mismatch of modules tool and definition of 'module' function",
                                            None, 'store_true', False),
            'cleanup-builddir': ("Cleanup build dir after successful installation. Also: --disable-cleanup-builddir",
                                 None, 'store_true', True),
            'cleanup-tmpdir': ("Cleanup tmp dir after successful run. Also: --disable-cleanup-tmpdir",
                               None, 'store_true', True),
