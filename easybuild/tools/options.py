...
from easybuild.tools.config import DEFAULT_LOGFILE_FORMAT, DEFAULT_JOB_SERVER
from easybuild.tools.config import DEFAULT_MNS, DEFAULT_MODULES_TOOL, DEFAULT_MODULECLASSES
...
from easybuild.tools.job import avail_job_servers
    ...
    def basic_options(self):
        ...
        opts = OrderedDict({
            ...
            'job-backend': ("What job runner to use", 'choice', 'store',
                            DEFAULT_JOB_SERVER, (avail_job_servers().keys())),
