...
class EasyBuildOptions(GeneralOption):
    ...
    def basic_options(self):
        ...
        opts = OrderedDict({
            ...
            'force': ("Force to rebuild software even if it's already installed (i.e. if it can be found as module) skipping OS dependencies checks",
            ...
            'rebuild': ("Rebuild software, even if module already exists (don't skip OS dependencies checks)", None, 'store_true', False),
