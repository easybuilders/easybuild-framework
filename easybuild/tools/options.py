...
class EasyBuildOptions(GeneralOption):
    ...
    def override_options(self):
        ...
        opts = OrderedDict({
            ...
            'dry-run-builddependencies-char': ("Output character for builddependencies in a dry-run", None,
                                               'store', '*'),
            'dry-run-dependencies-char': ("Output character for builddependencies in a dry-run", None, 'store', '*'),
