...
from easybuild.tools.config import DEFAULT_REPOSITORY, DEFAULT_STRICT, DEFAULT_TEST, KNOWN_TESTS
...
class EasyBuildOptions(GeneralOption):
    ...
    def basic_options(self):
        ...
        opts = OrderedDict({
            ...
            'test': ("Run unit tests for specified EasyBuild repository", 'choice', 'store_or_None', None, KNOWN_TESTS),
        })
