...
class EasyBuildOptions(GeneralOption):
    ...
    def github_options(self):
        ...
        opts = OrderedDict({
            'check-github': ("Check access to GitHub, and report back", None, 'store_true', False),
            ...
            'install-github-token': ("Install GitHub token (requires --github-user)", str, 'store', None),
