...
class EasyBuildOptions(GeneralOption):
    ...
    def override_options(self):
        ...
        opts = OrderedDict({
            ...
            'filter-rpath-sanity-libs': ("List of libraries that you want to ignore when the RPATH sanity check is "
                                         "performed. I.e. if these libraries are not RPATH-ed, that will be accepted "
