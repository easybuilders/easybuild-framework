...
COMPILER_MAP_CLASS = {
    FlagList: [("OPTFLAGS", "Optimization flags"), ("PRECFLAGS", "FP precision flags"),]
    + COMPILER_FLAGS,
    LibraryList: [
...
MPI_COMPILER_VARIABLES = [
    (MPI_COMPILER_TEMPLATE % {"c_var": v}, "MPI %s wrapper" % d)
    for (v, d) in COMPILER_VARIABLES
]

SEQ_COMPILER_TEMPLATE = "%(c_var)s_SEQ"
SEQ_COMPILER_VARIABLES = [
    (SEQ_COMPILER_TEMPLATE % {"c_var": v}, "sequential %s" % d)
    for (v, d) in COMPILER_VARIABLES
]
...
BLAS_MAP_CLASS = {
    ...
    CommaStaticLibs: [
        ...
        (
            "BLAS_MT_STATIC_LIBS",
            "Comma-separated list of static multithreaded BLAS libraries",
        ),
    ],
}
LAPACK_MAP_CLASS = {
    ...
    CommaStaticLibs: [
        ...
        (
            "BLAS_LAPACK_STATIC_LIBS",
            "Comma-separated list of static BLAS and LAPACK libraries",
        ),
        (
...
BLACS_MAP_CLASS = {
    ...
    CommaStaticLibs: [
        ...
        (
            "BLACS_MT_STATIC_LIBS",
            "Comma-separated list of static multithreaded BLACS libraries",
        ),
    ],
}
...
SCALAPACK_MAP_CLASS = {
    ...
    CommaStaticLibs: [
        ...
        (
            "SCALAPACK_MT_STATIC_LIBS",
            "Comma-separated list of static SCALAPACK libraries",
        ),
    ],
}
...
FFT_MAP_CLASS = {
    ...
    CommaStaticLibs: [
        ...
        (
            "FFT_STATIC_LIBS_MT",
            "Comma-separated list of static multithreaded FFT libraries",
        ),
    ],
}
...
FFTW_MAP_CLASS = {
    ...
    CommaStaticLibs: [
        ...
        (
            "FFTW_STATIC_LIBS_MT",
            "Comma-separated list of static multithreaded FFTW libraries",
        ),
    ],
}
