...
implement support for installing particular (groups of) software packages.""",
    ...
    packages = ["easybuild", "easybuild.framework", "easybuild.framework.easyconfig",
                ...
                "easybuild.tools.toolchain", "easybuild.tools.module_naming_scheme", "test.framework",
                "vsc", "vsc.utils", "test",
               ],
...
""" + read("README.rst"),
    ...
    provides=["eb", "easybuild.framework", "easybuild.toolchains", "easybuild.toolchains.compiler",
                ...
                "easybuild.tools", "easybuild.tools.toolchain", "easybuild.tools.module_naming_scheme", "vsc", "vsc.utils", "test"],
