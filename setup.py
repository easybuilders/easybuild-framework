...
implement support for installing particular (groups of) software packages.""",
    ...
    packages = ["easybuild", "easybuild.framework", "easybuild.toolchains", "easybuild.toolchains.compiler", "easybuild.toolchains.mpi",
                "easybuild.toolchains.fft", "easybuild.toolchains.linalg", "easybuild.tools", "easybuild.tools.toolchain", "easybuild.test"],
    ...
    platforms = "Linux",
    provides = ["eb", "easybuild.framework", "easybuild.toolchains", "easybuild.toolchains.compiler", "easybuild.toolchains.mpi",
                "easybuild.toolchains.fft", "easybuild.toolchains.linalg""easybuild.tools", "easybuild.tools.toolchain", "easybuild.test"],
