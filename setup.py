...
implement support for installing particular (groups of) software packages.""",
    ...
    packages = ["easybuild", "easybuild.framework", "easybuild.tools", "easybuild.tools.toolchain", "easybuild.test"],
    ...
    platforms = "Linux",
    provides = ["eb", "easybuild.framework", "easybuild.tools", "easybuild.tools.toolchain", "easybuild.test"],
